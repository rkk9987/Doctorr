...
const MyProfile = () => {
  const { userData, setUserData, getUserData, uToken } = useContext(AppContext);
  // const [userData, setUserData] = useState(user);
  // {
  //     name: "Edward Vincent",
  //     image: assets.profile_pic,
  //     email: "richard@gmail.com",
  //     phone: "+1 383 9334 4334",
  //     address: {
  ...
  const updateProfile = () => {
    try {
      ...
      fd.append("address", JSON.stringify(userData.address));
      ...
      axios
        .post("http://localhost:8001/api/user/update-user", fd, {
          headers: { uToken },
        })
        .then((res) => {
